document.addEventListener('DOMContentLoaded', function(){
    ...
    const captchaStatus = document.getElementById('status-info');
    drawCaptcha(captchaText);

    function verifyCaptcha(){
        var inputText = document.getElementById('user-inp').value.toLowerCase();
    ...
    document.getElementById('check-btn').addEventListener('click', verifyCaptcha);
